const registeredRollbackSuites = await Promise.all([
  ...
  import("./rollback-descriptor-acquisition.test.mjs"),
  import("./rollback-descriptor-teardown.test.mjs"),
  import("./rollback-production-finalization.test.mjs"),
  import("./rollback-temporary-finalization.test.mjs"),
  import("./rollback-command-finalization.test.mjs"),
  import("./rollback-evidence-custody.test.mjs"),
  import("./rollback-proof-construction.test.mjs"),
  import("./rollback-directory-open.test.mjs"),
  import("./rollback-consumer-finalization.test.mjs"),
  import("./rollback-runtime-finalization.test.mjs"),
  import("./rollback-runtime-integration.test.mjs"),
  import("./toolchain-archive-finalization.test.mjs"),
  import("./toolchain-node-lifecycle.test.mjs"),
