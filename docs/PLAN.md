...
14:04 UTC: файловое исправление4c93 прошло32/32 Mac-тестов и проверяется
критиком99. В EVMcfba покрыты все7 настоящих сценариев запуска, но критик98
нашёл пропущенную повторную проверку содержимого файла и потерю первичной
ошибки при сбое закрытия. Работник100 исправляет их. Черновики96/97 сохранены,
но не применены. Новые исправления пока не считаются принятыми.
