...
Исправления Foundation, TypeScript, линтера, ограничений JSON и двух замечаний
P2 к local-EVM готовы в отдельных коммитах; настоящие Mac/Anvil проверки
прошли, независимые ревью ещё выполняются. Механизм проверки отката остаётся
