...
- 3 сентября. Отдельный независимый работник сверяет все эти требования с
кодом. Они не отменены: до сверки нельзя считать, что осталось только
исправить откат, или переносить старые отклонённые ветки без проверки.
