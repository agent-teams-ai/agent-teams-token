...
замечания P2 к local-EVM закрыты, но ревью нашло одну новую ошибку очистки
данных во вложенной ошибке; исправление уже готово, проверено на Mac и
ожидает отдельного ревью перед интеграцией.
