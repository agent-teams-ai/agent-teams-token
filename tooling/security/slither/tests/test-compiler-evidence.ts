...
function build(source:string,path:string,contract:string,creationBytecode:string):{evidence:AnalysisInput["compilerEvidence"]}{
  ...
  const input={sources:{[path]:{content:source}},settings}; const artifact={abi:[],bytecode:{object:creationBytecode}}; const buildInfo={solcVersion:"0.8.36+commit.8a079791",input,output:{contracts:{[path]:{[contract]:{evm:{bytecode:{object:creationBytecode}}}}}}};
