...
const securityPrelude = [
  "set -euo pipefail",
  "printf '%s\\n' container-execution > /output/failure.stage",
  ...
  "printf '%s\\n' version-inventory > /output/failure.stage",
  ...
  "printf '%s\\n' detector-inventory > /output/failure.stage",
...
export function dockerRunArguments(paths: ContainerPaths): readonly string[] {
  const script = [
    ...securityPrelude,
    "printf '%s\\n' manifest-validation > /output/failure.stage",
    ...
    "printf '%s\\n' analysis-runtime > /output/failure.stage",
    "set +e",
    ...
    "printf '%s\\n' artifact-validation > /output/failure.stage",
