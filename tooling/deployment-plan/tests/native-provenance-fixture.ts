...
import { parseJsonWithoutDuplicates } from "../src/adapters/strict-json.ts";
...
export const nativeNoReplacePolicy: NativeNoReplacePolicy = {
  ...
  platforms: {
    ...
    "linux-x64": { strategy: "snapshot-fd", tuples: [{ compilerPath: "/usr/bin/x86_64-linux-gnu-gcc-13", compilerSha256: "0x1b99826121ae6682a634e5efe09bd3e3df58ce58e0b28f849114ab5b89139c26", executableSha256: "0x814aba8dfb8f176c252a3fc8f4aa8564723c0790613ee101a9a45fc41f629e9b" }] },
  },
};
const fields: NativeNoReplaceEvidenceFields = {
  ...
  compilerExecution: "snapshot-fd", compilerPath: "/usr/bin/x86_64-linux-gnu-gcc-13",
